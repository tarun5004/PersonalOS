...
export function AppLayout({ routes }) {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#e9edf7,var(--theme-app-bg)_48%,#f8fafc)] p-0 text-body sm:p-5 lg:p-8">
      <a
      ...
      <div className="mx-auto grid min-h-screen w-full max-w-[1220px] overflow-hidden border border-border bg-surface shadow-panel sm:min-h-[calc(100vh-40px)] sm:rounded-[26px] lg:min-h-[calc(100vh-64px)] lg:grid-cols-[96px_minmax(0,1fr)]">
